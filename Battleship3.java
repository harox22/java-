...
public class Battleship2{
	public static void main(String[] args){
		...
		int[] player1_ship_row=new int[5];
		int[] player1_ship_col=new int[5];  
		 
		int[] player2_ship_row=new int[5];
		int[] player2_ship_col=new int[5];
		  
				...
				int hit_row=input.nextInt();				
					if (input.hasNextInt()){
						...
						if (hit_row>5 || hit_col>5){
							...
							for(int i=0;i<player1_ship_row.length;i++){
								if ((hit_row==player2_ship_row[i]) && (hit_col==player2_ship_col[i])){
    									System.out.print("PLAYER 1 HIT PLAYER 2’s SHIP!");
				...
				int hit_row=input.nextInt();
					...
					if (input.hasNextInt()){
						...
						if (hit_row>5 || hit_col>5){
							...
							for(int i=0;i<player1_ship_row.length;i++){
								if ((hit_row==player1_ship_row[i]) && (hit_col==player1_ship_col[i])){
    									System.out.print("PLAYER 2 HIT PLAYER 1’s SHIP!");
